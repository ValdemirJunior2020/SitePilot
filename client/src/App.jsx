...
import PriceWatchDetails from './pages/PriceWatchDetails';
...
export default function App(){return <BrowserRouter><AuthProvider><ToastProvider><Routes>
  ...
  <Route path="/dashboard" element={<ProtectedRoute><AppShell/></ProtectedRoute>}>
    <Route index element={<Dashboard/>}/><Route path="price-watch" element={<PriceWatches/>}/><Route path="price-watch/:id" element={<PriceWatchDetails/>}/><Route path="sites" element={<Sites/>}/><Route path="sites/:id" element={<SiteDetails/>}/><Route path="sites/:id/scans/:scanId" element={<ScanDetails/>}/><Route path="activity" element={<ActivityPage/>}/><Route path="reports" element={<Reports/>}/><Route path="settings" element={<Settings/>}/>
